...
export class UserComponent {
  ...
  values = signal<passwordUpdateValues>({
    old_password: null,
    new_password: null,
    confirm_password: null,
  });
  errors = signal<passwordUpdateErrors>({
    old_password: null,
    new_password: null,
    confirm_password: null,
    global: null,
          ...
          catchError((error: HttpErrorResponse) => {
            ...
            if (res && Array.isArray(res.message)) {
              ...
              if (res.message.includes('Old')) {
                ...
                res.message.includes('least') ||
                res.message.includes('must')
              ) {
                this.errors.update((prev) => ({
                  ...prev,
  ...
  changeField(
    event: Event,
    type: 'old_password' | 'new_password' | 'confirm_password'
  ) {
