export const main_domain = import.meta.env.NG_APP_MAIN_DOMAIN;
export const email_address = import.meta.env.NG_APP_EMAIL_ADDRESS;
...
const BACKEND_PROTOCOL = import.meta.env.NG_APP_BACKEND_PROTOCOL;
const BACKEND_HOST = import.meta.env.NG_APP_BACKEND_HOST;
const BACKEND_PORT = import.meta.env.NG_APP_BACKEND_PORT;
