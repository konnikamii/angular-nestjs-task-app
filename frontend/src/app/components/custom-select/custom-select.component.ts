import { Component, ElementRef, input, OnDestroy, OnInit, output, signal } from '@angular/core';
...
export class CustomSelectComponent implements OnInit, OnDestroy {
  ...
  selectionClassName = input<string>(' px-3 py-1 border border-gray-500 bg-gray-50 dark:bg-gray-700 rounded-md cursor-pointer ');
  dropdownClassName = input<string>(' absolute left-0 right-0 mt-1 bg-gray-50 dark:bg-gray-700 border border-gray-500 rounded-md shadow-lg z-10 ');
  ...
  checkDropdownPosition() {
    ...
    if (rect.bottom + dropdownHeight > viewportHeight*.9) {
